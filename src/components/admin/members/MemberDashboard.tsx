...
export default function MemberDashboard() {
  ...
  function handleMemberSelect(member: TableDataLine) {
      ...
      <div className="flex justify-between py-2">
        ...
        <div className="items-center gap-x-2 flex">
          <div>
            ...
            >
              <p>
                Importing is intended for backups and such. One can only import
                a .csv file exactly like the one generated by clicking Download
                .csv at the Table footer. Use it as a template.
              </p>
              <p>
                If the column headers of the csv file do not match exactly it
                will be rejected. The key column of each member must match the
              ...
              {/* <input
                  ...
                  accept=".csv,.CSV,"
                /> */}
              <Upload name="uploadeMembers" accept=".csv,.CSV">

...
//       this.setState({
//         ...this.state,
//         removingInProcess: Object.assign(this.state.removingInProcess, {
//           [sessionId]: true,
//         }),
//       })
...
//         .catch((err) => {
//           notification.error({
//             message: 'Error adding to session: ' + err.toString(),
//           })
//         })
//         .finally(() => {
//           this.setState({
...
//     }
//   }
//   onMoveClick = (clickParam: { key: Key }, fromSession: string) => {
//     const { key } = clickParam
//     if (typeof key !== 'string') {
//       return notification.error({
//         message: 'Ant-D error: click handler returned non-string value',
//       })
//     }
...
//       return notification.error({
//         message:
//           'No user found for user id ' + currentUserIdSelected + ' in session',
//       })
//     }
//     this.setState({
//       ...this.state,
...
//           return (
//             <Menu.Item
//               disabled={moveObj.isCurrentDropdown || !moveObj.isSpaceLeft}
//               key={moveObj.sessionId}
//             >
//               {moveObj.title}
//               {!moveObj.isSpaceLeft ? '(full)' : ''}
//             </Menu.Item>
//           )
//         })}
//       </Menu>
...
//                         className="weekStatEachContainer"
//                       >
//                         <Statistic
//                           title={session.title}
//                           value={Object.keys(session.members).length}
//                           suffix={`/ ${session.limit}`}
//                         />
//                       </div>
//                     </div>
//                   </Col>
...
//                       onChange={(e) =>
//                         this.onSelectChange(e, session.sessionId)
//                       }
//                     >
//                       {Object.keys(session.members)
//                         .sort((a, b) => this.memberSort(a, b, session))
//                         .map((member) => {
//                           return (
//                             <Select.Option key={member} value={member}>
//                               {session.members[member].name}
//                               {member.indexOf('NONMEMBER') > -1
//                                 ? ' (non-member)'
//                                 : ''}
//                             </Select.Option>
//                           )
...
//                             }
//                             loading={
//                               this.state.addingInProcess[session.sessionId]
//                             }
//                           >
//                             Add
//                           </Button>
...
//                       <Dropdown
//                         disabled={
//                           !this.state.selectedMembers[session.sessionId]
//                         }
...
//                         <Button
//                           loading={
//                             this.state.movingInProcess[session.sessionId]
//                           }
//                         >
//                           Move...
//                         </Button>
...
//                       <Button
//                         loading={
//                           this.state.removingInProcess[session.sessionId]
//                         }
//                         disabled={
//                           !this.state.selectedMembers[session.sessionId]
//                         }
...
export default function EditSignups({ training }: EditSignupsProps) {
  ...
  //         <Collapse
  //           items={items}
  //           className="flex justify-between items-center w-full hover:bg-gray-50 px-4 py-4"
  //         >
  ...
  //           </span>
  //         </Collapse>
  //         {index < sortedSessions.length - 1 && <Divider className="!my-0" />}
  //       </>
  //     ))}
  //   </ul>
  // )
  ...
  return (
    <div>
      ...
      <form className="flex mt-2" onSubmit={handleSubmit}>
        ...
        />
        <Button htmlType="submit" className="!border-l-0">
          Add
        </Button>
      </form>
    </div>

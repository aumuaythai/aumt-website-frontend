...
export class EventSignupDetails extends Component<EventSignupDetailsProps> {
          ...
          <table className="eventSignupDetailTable">
            <tbody>
              ...
              <tr>
                ...
                <td className="esDetailData">{this.props.selectedRow.email}</td>
              </tr>
              <tr>
                <td className="esDetailLabel">
                  ...
                  <Button
                    ...
                    onClick={(e) =>
                      this.updateConfirmed(
                        ...
                        !this.props.selectedRow?.confirmed
                      )
                    }
                  >
                    Change
          ...
          <table className="eventSignupDetailTable">
            <tbody>
              ...
              <tr className="esDetailLine">
                ...
                <td className="ecDetailData">
                  {this.props.selectedRow.seatsInCar &&
                  this.props.selectedRow.seatsInCar > -1
                    ? `Yes, ${this.props.selectedRow.seatsInCar}`
                    : 'No'}
                </td>
              </tr>
              <tr className="esDetailLine">

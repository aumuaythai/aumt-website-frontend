                        ...
                        if (!form.openToPublic) {
                            if (!this.props.authedUserId) {
                                ...
                                return <div key={form.trainingId} className='signupsNotPaidContainer'>
                                    ...
                                    <p>Membership is $45 for the semester and can be paid by cash to a committee member or transfer to the bank account below (with your NAME in the reference).</p>

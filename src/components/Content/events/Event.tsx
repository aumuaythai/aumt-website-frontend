            ...
            <div className='eventContainer'>
                ...
                {(() => {
                    if (this.props.event.signups) {
                            ...
                            return <div>
                                ...
                                subTitle={!this.state.confirmedSignUp ?
                                    ...
                                    extra={this.state.confirmedSignUp ? [] : 
                                        [
                                            <p key='xtra' className='joinAccountLine'>The fee is $180 and should be paid with your full name as the reference to: 06-0158-0932609-00
                        ...
                        return <div>
                            {/* {signups.opens.getTime() > new Date().getTime() ?
                                <div>Signups will open {moment(signups.opens).format('MMMM Do')}</div>
                                : signups.closes.getTime() < new Date().getTime() ?

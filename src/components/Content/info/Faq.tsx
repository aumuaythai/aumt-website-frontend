        ...
        return (
            <div className='faqContainer'>
                ...
                <div className="questionContainer" key="join">
                    ...
                    <p className="answer">
                    A: You can join anytime throughout the year. Just pay for your membership as per the instructions. 
                    <br/>If your payment has not been processed after a few days, let us know.
                ...
                <div className="questionContainer" key="bring">
                    ...
                    <br/><em>We highly recommend buying handwraps.</em>

                    <br/><br/>The club provides gloves and shinpads.
                    <br/><em>If you have your own, please bring them.</em>

                    <br/><br/>For Intermediate/sparring, you must have a mouthguard.
                    <br/>
                    <br/>
                    </p>
                </div>

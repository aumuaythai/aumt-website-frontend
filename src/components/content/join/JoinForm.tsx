...
export default function JoinForm() {
  ...
  function handleValid(data: JoinForm) {
    console.log(data)
  }
  ...
  return (
    <div className="max-w-[600px] text-left mx-auto px-8">
      ...
      <p>
        Welcome to AUMT! We look forward to you being a part of our club. Please
        fill in the form below to create an account. Your account will enable
        you to sign up to future training sessions and join events. Please
      ...
      <p>
        I understand that by filling out and submitting this form, I am
        partaking in the club activities at my own risk and all injuries
        sustained to any person or any damage to equipment during the ordinary
        course of training will not be the responsibility of the club. Any loss
        of equipment or personal belongings is the sole responsibility of the
        member and is not the responsibility of the club or training facility.
      </p>
      ...
      >
        ...
        <div>
          ...
          <p>
            This is your account to sign in to this site for trainings and
            events. Your email here will be used both as your username for the
            account and as a point of contact for club announcements and
            invitations. You can reset your password at any time.
          </p>
        </div>
        ...
        <FormItem control={control} name="preferredName" label="Preferred Name">
          <Input placeholder="If different from first name" />
        </FormItem>

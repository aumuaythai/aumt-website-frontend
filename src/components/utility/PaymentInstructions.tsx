    ...
    return (
      <div>
        {this.props.paymentType === 'Bank Transfer' ? (
          ...
          //       type="link"
          //       onClick={(e) =>
          //         this.copyText(`${this.props.clubConfig?.bankAccountNumber}`)
          //       }
          //     >
          //       Copy Account Number
          //     </Button>
          ...
          <p>
            ...
            <br />
            {this.props.membershipType === 'S1' &&
              `Club Expo Special Price: Membership is $${this.props.clubConfig?.semesterOneFee} for the semester or $${this.props.clubConfig?.fullYearFee} for the year if paid before Sunday. After Sunday, the annual
            membership price will increase to $140.`}
            {this.props.membershipType === 'FY' &&
              `Club Expo Special Price: Membership is $${this.props.clubConfig?.fullYearFee} for the year if paid before Sunday. After Sunday, the annual
            membership price will increase to $140.`}
            {this.props.membershipType === 'S2'
              ? ` $${this.props.clubConfig?.semesterTwoFee} for the semester `
              : ''}
            ...
            <br />
            <br />
            This should be paid with your full name as the reference to:
            <div style={{ textAlign: 'center' }}>
              {' ' + this.props.clubConfig?.bankAccountNumber}
              <Button
                type="link"
